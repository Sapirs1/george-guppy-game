import type { LevelConfig } from '../data/levels.js';
 ...
 */
export function formatUiText(levelName: string, bubbleCount: number): string {
 ...
 */
export function clampLevelIndex(index: number, levelCount: number): number {
...
export function validateLevelData(
  ...
  dialogues: Readonly<Record<string, readonly DialogueLine[]>>,
